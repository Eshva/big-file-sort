...
internal class PartsBuilder1 : IPartBuilder
{
  public PartsBuilder1(
  ...
  private void BuildPart(List<NumberedLine> partLines, FileInfo partFile)
  {
    ...
    {
      writer.WriteLine(partLine.ToString());
    }
  }
  ...
  private readonly ISorter<NumberedLine> _sorter = new TypedBubbleSorter<NumberedLine>();

...
public class given_external_merge_file_sorter1 : IClassFixture<IndependentFilesGeneratorFixture>
{
  public given_external_merge_file_sorter1(IndependentFilesGeneratorFixture filesGeneratorFixture)
  {
  ...
  public void when_sort_and_merge_requires_many_passes_it_should_produce_sorted_file()
  {
    ...
    var maxTempFiles = 7;
    var kWayMergeFactor = 5;
    var partCount = maxTempFiles - ExternalMergeFileSorterOptions1.AlwaysPresentMergedPartsNumber;

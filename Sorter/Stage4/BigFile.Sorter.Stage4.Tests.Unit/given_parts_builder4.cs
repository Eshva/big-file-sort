...
public class given_parts_builder4 : IClassFixture<IndependentFilesGeneratorFixture>, IDisposable
{
  public given_parts_builder4(IndependentFilesGeneratorFixture filesGeneratorFixture)
  {
  ...
  public void when_build_sorted_parts_and_source_file_has_exceeding_number_of_lines_it_should_produce_maximum_files_with_expected_content()
  {
    ...
    var partsBuilder = new PartsBuilder4(

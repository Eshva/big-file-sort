...
public class given_lines_min_heap_sorter
{
  public given_lines_min_heap_sorter()
  {
    _sorter = new LinesMinHeapSorter(new StubStringComparer());
  }
  ...
  private readonly LinesMinHeapSorter _sorter;

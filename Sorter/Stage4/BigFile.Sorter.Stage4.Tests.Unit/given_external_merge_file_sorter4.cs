...
public class given_external_merge_file_sorter4 : IClassFixture<IndependentFilesGeneratorFixture>
{
  public given_external_merge_file_sorter4(IndependentFilesGeneratorFixture filesGeneratorFixture)
  {
  ...
  public void when_sort_and_merge_requires_many_passes_it_should_produce_sorted_file()
  {
    ...
    var partCount = (maxTempFiles - ExternalMergeFileSorterOptions4.AlwaysPresentMergedPartsNumber) * 3;
  ...
  {
    const int maxTempFiles = 7;
    var partCount = maxTempFiles - ExternalMergeFileSorterOptions4.AlwaysPresentMergedPartsNumber - 1;
